...
export function initWebSocket(server) {
    ...
    wss.on('connection', (ws, req) => {
        ...
        const conn = { ws, agentId, connectedAt: new Date(), lastPingAt: new Date() };
...
export function broadcastToolResult(callId, result, agentId) {
    broadcastMessage({
        from: 'Orchestrator',
        to: agentId,
        source: 'orchestrator',
...
//# sourceMappingURL=chat-broadcaster.js.map