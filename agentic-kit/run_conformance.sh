...
run_test "C1" "EvidenceObject Creation (ADR-003)"      "test_c1_evidence_create.py"
run_test "C2" "Hash-Chain Integrity (ADR-003)"          "test_c2_hash_chain.py"
run_test "C3" "HITL Gate Enforcement (ADR-004)"         "test_c3_hitl_gate.py"
run_test "C4" "MRP Cluster Generation (ADR-002)"        "test_c4_mrp_clusters.py"
run_test "C5" "Dynamic Router Validity Gate"            "test_c5_router_validity.py"
run_test "C6" "Idempotency (ADR-002)"                   "test_c6_idempotency.py"
run_test "C7" "Router Fallback Chain"                   "test_c7_fallback.py"
